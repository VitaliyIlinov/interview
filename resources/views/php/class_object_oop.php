...
<p>
    ...
    кроме того, область видимости этих методов должна совпадать (или быть менее строгой). Например, если абстрактный
    метод объявлен как protected, то реализация этого метода должна быть protected или public, но не private.
</p>
...
<p>
    ...
    который будет реализовывать интерфейс. При этом интерфейс не должен содержать реализацию указанных методов. Он
    содержит просто перечисление того, что должно быть в классе (прототипы функций).
</p>
<p>
