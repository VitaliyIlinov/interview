                    ...
                    <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img class="d-block w-100" src="/admin/img/ui_element/carousel/card-img-1.jpg" alt="First slide">
                            </div>
                            <div class="carousel-item">
                                <img class="d-block w-100" src="/admin/img/ui_element/carousel/card-img-2.jpg" alt="Second slide">
                            </div>
                            <div class="carousel-item">
                                <img class="d-block w-100" src="/admin/img/ui_element/carousel/card-img-3.jpg" alt="Third slide">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                ...
                                <div class="carousel-caption d-none d-md-block">
                                    ...
                                    <p>Mauris fermentum elementum ligula in efficitur. Aliquam id congue lorem. Proin
                                        consectetur feugiat enim ut luctus. Aliquam pellentesque ut tellus ultricies
                                        bibendum.</p>
                                </div>
                            </div>
                            <div class="carousel-item">
