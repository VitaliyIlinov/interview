        ...
        <div class="col-xl-10">
            ...
            <div class="page-section" id="overview">
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <h2>Overview</h2>
                        <p class="lead">Nam pulvinar interdum turpis a mattis. Etiam augue leo, mollis a massa sagittis,
                            egestas pretium risus. Aliquam auctor nibh mauris, at fringilla elit lobortis sodales.
                            Praesent volutpat felis et placerat elementum. </p>
            ...
            <div class="row">
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="card" id="text">
                        ...
                        <div class="card-body">
                            <p class="lead"> Maecenas eget metus quis justo semper malesuada id id leo. Mauris tristique
                                libero mauris, vitae rutrum mi ultricies a. Vestibulum volutpat eu leo sit amet
                                feugiat. </p>
                            <p>Pellentesque pellentesque elementum sem, eu interdum magna. Aenean vestibulum, erat vel
                                tincidunt luctus, ex orci interdum est, ut vehicula erat massa ut purus. Nam sit amet
                                odio quis ante bibendum faucibus. Mauris eleifend lobortis justo vel dictum. Aenean
                                lobortis eleifend turpis, sit amet ullamcorper dui euismod at. </p>
                        </div>
                    </div>
                </div>
                <!-- ============================================================== -->
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="card" id="align">
                        ...
                        <div class="card-body">
                            ...
                            <p class="text-left">Pellentesque vulputate arcu sed risus auctor tincidunt. Morbi eget
                                massa turpis. Fusce aliquet dolor eu posuere tincidunt. Fusce ultricies luctus dui,
                                dapibus pharetra risus semper non. .</p>
                        </div>
                        <div class="card-body border-top">
                            <h3 class="text-center">Center aligned text.</h3>
                            <p class="text-center">Pellentesque vulputate arcu sed risus auctor tincidunt. Morbi eget
                                massa turpis. Fusce aliquet dolor eu posuere tincidunt. Fusce ultricies luctus dui,
                                dapibus pharetra risus semper non. .</p>
                        </div>
                        <div class="card-body border-top">
                            <h3 class="text-right">Right aligned text.</h3>
                            <p class="text-right">Pellentesque vulputate arcu sed risus auctor tincidunt. Morbi eget
                                massa turpis. Fusce aliquet dolor eu posuere tincidunt. Fusce ultricies luctus dui,
                                dapibus pharetra risus semper non. .</p>
                        </div>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="card" id="blockquote">
                        ...
                        <div class="card-body border-top">
                            <blockquote class="blockquote">
                                <p class="mb-1">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer posuere
                                    erat a ante.</p>
