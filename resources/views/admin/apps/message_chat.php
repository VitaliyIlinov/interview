            ...
            <div class="chat-module-top">
                ...
                <div class="chat-module-body">
                    <div class="media chat-item">
                        <img alt="William" src="/admin/img/apps/avatar-1.jpg" class="rounded-circle user-avatar-lg">
                        <div class="media-body">
                            ...
                            <div class="chat-item-body">
                                <p>Hey guys, Phasellus imperdiet arcu venenatis, malesuada nulla a, porta sem. Curabitur
                                    nec massa ultrices, consequat erat sit amet, luctus justo. Brand Concept &amp;
                                    Design!</p>
                            </div>
                        </div>
                    </div>
                    <div class="media chat-item">
                        <img alt="Komal" src="/admin/img/apps/avatar-2.jpg" class="rounded-circle user-avatar-lg">
                        <div class="media-body">
                            <div class="chat-item-title">
                            ...
                            <div class="chat-item-body">
                                <p>Nice one <a href="#">@Komal</a>, Nulla ut diam porttitor odio malesuada malesuada eu
                                    at ipsum.
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="media chat-item">
                        <img alt="tanu" src="/admin/img/apps/avatar-3.jpg" class="rounded-circle user-avatar-lg">
                        <div class="media-body">
                            <div class="chat-item-title">
                            ...
                            <div class="chat-item-body">
                                <p>Roger that boss! <a href="#">@Ravi</a> Donec quis ante ut felis tincidunt blandit. 🔥
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="media chat-item">
                        <img alt="Bhoomi" src="/admin/img/apps/avatar-4.jpg" class="rounded-circle user-avatar-lg">
                        <div class="media-body">
                            <div class="chat-item-title">
                    ...
                    <div class="media chat-item">
                        ...
                        <div class="media-body">
                            ...
                            <div class="chat-item-body">
                                <p>Can't wait! <a href="#">@David</a> Curabitur nec massa ultrices, consequat erat sit
                                    amet, luctus justo. <a href="#"> Meeting</a>?</p>
                            </div>
                        </div>
                    </div>
                    <div class="media chat-item">
                        <img alt="Daniel" src="/admin/img/apps/avatar-2.jpg" class="rounded-circle user-avatar-lg">
                        <div class="media-body">
                            <div class="chat-item-title">
                    ...
                    <div class="media chat-item">
                        <img alt="Fallon" src="/admin/img/apps/avatar-3.jpg" class="rounded-circle user-avatar-lg">
                        <div class="media-body">
                            <div class="chat-item-title">
                    ...
                    <div class="media chat-item">
                        <img alt="Kimberly" src="/admin/img/apps/avatar-4.jpg" class="rounded-circle user-avatar-lg">
                        <div class="media-body">
                            <div class="chat-item-title">
                            ...
                            <div class="chat-item-body">
                                <p>Well done <a href="#">@all</a>. See you all Fusce tempus ipsum a mi rutrum, at
                                    dignissim mauris vulputate. 🤜</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="chat-team-sidebar text-small">
                    <div class="chat-team-sidebar-top">
                        <div class="media align-items-center">
                            <a href="#" class="mr-2">
                                <img alt="Team Avatar" src="/admin/img/apps/avatar-2.jpg"
                        ...
                        <ul class="nav nav-tabs nav-justified" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active show" id="members-tab" data-toggle="tab" href="#members"
                                ...
                                <div id="test-list">
                                    <form class="px-3 mb-3">
                                        <div class="input-group input-group-round">
                                            ...
                                            <input type="text" class="form-control search" placeholder="Filter members"
                                    ...
                                    <div class="list-group list-group-flush  list">
                                        <a class="list-group-item list-group-item-action" href="#">
                                            <div class="media media-member mb-0">
                                                <img alt="Claire Connors" src="/admin/img/apps/avatar-1.jpg"
                                                     class="avatar">
                                                <div class="media-body ">
                                        ...
                                        <a class="list-group-item list-group-item-action" href="#">
                                            <div class="media media-member mb-0">
                                                <img alt="Marcus Simmons" src="/admin/img/apps/avatar-2.jpg"
                                                     class="avatar">
                                                <div class="media-body">
                                        ...
                                        <a class="list-group-item list-group-item-action" href="#">
                                            <div class="media media-member mb-0">
                                                <img alt="Peggy Brown" src="/admin/img/apps/avatar-3.jpg"
                                                     class="avatar">
                                                <div class="media-body">
                                        ...
                                        <a class="list-group-item list-group-item-action" href="#">
                                            <div class="media media-member mb-0">
                                                <img alt="Harry Xai" src="/admin/img/apps/avatar-3.jpg" class="avatar">
                                                <div class="media-body">
                                        ...
                                        <a class="list-group-item list-group-item-action" href="#">
                                            <div class="media media-member mb-0">
                                                <img alt="Sally Harper" src="/admin/img/apps/avatar-1.jpg"
                                                     class="avatar">
                                                <div class="media-body">
                                        ...
                                        <a class="list-group-item list-group-item-action" href="#">
                                            <div class="media media-member mb-0">
                                                <img alt="Ravi Singh" src="/admin/img/apps/avatar-2.jpg"
                                                     class="avatar">
                                                <div class="media-body">
                                        ...
                                        <a class="list-group-item list-group-item-action" href="#">
                                            <div class="media media-member mb-0">
                                                <img alt="David Whittaker" src="/admin/img/apps/avatar-3.jpg"
                                                     class="avatar">
                                                <div class="media-body">
                                        ...
                                        <a class="list-group-item list-group-item-action" href="#">
                                            <div class="media media-member mb-0">
                                                <img alt="Kerri-Anne Banks" src="/admin/img/apps/avatar-4.jpg"
                                                     class="avatar ">
                                                <div class="media-body ">
                                        ...
                                        <a class="list-group-item list-group-item-action " href="# ">
                                            <div class="media media-member mb-0 ">
                                                <img alt="Masimba Sibanda " src="/admin/img/apps/avatar-3.jpg"
                                                     class="avatar">
                                                <div class="media-body">
                                        ...
                                        <a class="list-group-item list-group-item-action" href="#">
                                            <div class="media media-member mb-0">
                                                <img alt="Krishna Bajaj" src="/admin/img/apps/avatar-2.jpg"
                                                     class="avatar ">
                                                <div class="media-body ">
                                        ...
                                        <a class="list-group-item list-group-item-action " href="# ">
                                            <div class="media media-member mb-0 ">
                                                <img alt="Kenny Tran " src="/admin/img/apps/avatar-1.jpg"
                                                     class="avatar">
                                                <div class="media-body">
                                        ...
                                        <li class="list-group-item dz-preview dz-file-preview">
                                            <div class="media align-items-center dz-details">
                                                <ul class="avatars list-unstyled">
                                                    ...
                                                    <li>
                                                        <img alt="David Whittaker" src="/admin/img/apps/avatar-4.jpg"
                                                ...
                                                <div class="media-body d-flex justify-content-between align-items-center">
                                                    ...
                                                    <img alt="Loader" src="/admin/img/apps/loader.svg"
                                                         class="dz-loading">
                                                    <div class="dropdown">
                                        ...
                                        <li class="list-group-item" data-t="null" data-i="null" data-l="null"
                                            ...
                                            <div class="media align-items-center">
                                                <ul class="avatars list-unstyled">
                                                    ...
                                                    <li>
                                                        <img alt="Peggy Brown" src="/admin/img/apps/avatar-1.jpg"
                                        ...
                                        <li class="list-group-item">
                                            <div class="media align-items-center">
                                                <ul class="avatars list-unstyled">
                                                    ...
                                                    <li>
                                                        <img alt="Harry Xai" src="/admin/img/apps/avatar-2.jpg"
                                                             class="avatar filter-by-data-title" data-title="Harry Xai"
                                        ...
                                        <li class="list-group-item">
                                            <div class="media align-items-center">
                                                <ul class="avatars list-unstyled">
                                                    ...
                                                    <li>
                                                        <img alt="Ravi Singh" src="/admin/img/apps/avatar-4.jpg"
                                                             class="avatar filter-by-data-title" data-title="Ravi Singh"
                                                             data-toggle="tooltip" data-filter-by="data-title">
                                                    </li>
                                                </ul>
                                                <div class="media-body d-flex justify-content-between align-items-center">
                                        ...
                                        <li class="list-group-item">
                                            <div class="media align-items-center">
                                                <ul class="avatars list-unstyled">
                                                    ...
                                                    <li>
                                                        <img alt="Claire Connors" src="/admin/img/apps/avatar-3.jpg"
                                                             class="avatar filter-by-data-title"
