    ...
    <div class="row">
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="icon-list-demo row">
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 t-icon"><i class="ti-arrow-right"></i> ti-arrow-right
                        </div>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 t-icon"><i class="ti-angle-right"></i> ti-angle-right
                        </div>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 t-icon"><i class="ti-arrows-corner"></i> ti-arrows-corner
                        </div>
                        <div class="col-sm-6 col-md-4 col-lg-3 t-icon"><i class="ti-split-v"></i> ti-split-v</div>
                        <div class="col-sm-6 col-md-4 col-lg-3 t-icon"><i class="ti-split-v-alt"></i> ti-split-v-alt
                        </div>
                        <div class="col-sm-6 col-md-4 col-lg-3 t-icon"><i class="ti-split-h"></i> ti-split-h</div>
                        <div class="col-sm-6 col-md-4 col-lg-3 t-icon"><i class="ti-hand-point-up"></i> ti-hand-point-up
                        </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="icon-list-demo row">
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 t-icon"><i class="ti-direction-alt"></i> ti-direction-alt
                        </div>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 t-icon"><i class="ti-shopping-cart"></i> ti-shopping-cart
                        </div>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 t-icon"><i class="ti-ruler-alt-2"></i> ti-ruler-alt-2
                        </div>
                        <div class="col-sm-6 col-md-4 col-lg-3 t-icon"><i class="ti-ruler-pencil"></i> ti-ruler-pencil
                        </div>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 t-icon"><i class="ti-bookmark-alt"></i> ti-bookmark-alt
                        </div>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 t-icon"><i class="ti-paint-roller"></i> ti-paint-roller
                        </div>
                        <div class="col-sm-6 col-md-4 col-lg-3 t-icon"><i class="ti-paint-bucket"></i> ti-paint-bucket
                        </div>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 t-icon"><i class="ti-heart-broken"></i> ti-heart-broken
                        </div>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 t-icon"><i class="ti-comment-alt"></i> ti-comment-alt
                        </div>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 t-icon"><i class="ti-announcement"></i> ti-announcement
                        </div>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 t-icon"><i class="ti-shift-right"></i> ti-shift-right
                        </div>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 t-icon"><i class="ti-location-pin"></i> ti-location-pin
                        </div>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 t-icon"><i class="ti-bar-chart-alt"></i> ti-bar-chart-alt
                        </div>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 t-icon"><i class="ti-alarm-clock"></i> ti-alarm-clock
                        </div>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 t-icon"><i class="ti-video-clapper"></i> ti-video-clapper
                        </div>
                        <div class="col-sm-6 col-md-4 col-lg-3 t-icon"><i class="ti-video-camera"></i> ti-video-camera
                        </div>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 t-icon"><i class="ti-pencil-alt2"></i> ti-pencil-alt2
                        </div>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 t-icon"><i class="ti-line-double"></i> ti-line-double
                        </div>
                        <div class="col-sm-6 col-md-4 col-lg-3 t-icon"><i class="ti-line-dotted"></i> ti-line-dotted
                        </div>
                        <div class="col-sm-6 col-md-4 col-lg-3 t-icon"><i class="ti-line-dashed"></i> ti-line-dashed
                        </div>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 t-icon"><i class="ti-headphone-alt"></i> ti-headphone-alt
                        </div>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 t-icon"><i class="ti-credit-card"></i> ti-credit-card
                        </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="icon-list-demo row">
                        <div class="col-sm-6 col-md-4 col-lg-3 t-icon"><i class="ti-control-stop"></i> ti-control-stop
                        </div>
                        <div class="col-sm-6 col-md-4 col-lg-3 t-icon"><i class="ti-control-shuffle"></i>
                            ti-control-shuffle
                        </div>
                        <div class="col-sm-6 col-md-4 col-lg-3 t-icon"><i class="ti-control-play"></i> ti-control-play
                        </div>
                        <div class="col-sm-6 col-md-4 col-lg-3 t-icon"><i class="ti-control-pause"></i> ti-control-pause
                        </div>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 t-icon"><i class="ti-control-eject"></i> ti-control-eject
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="icon-list-demo row">
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 t-icon"><i class="ti-align-right"></i> ti-align-right
                        </div>
                        <div class="col-sm-6 col-md-4 col-lg-3 t-icon"><i class="ti-align-left"></i> ti-align-left</div>
                        <div class="col-sm-6 col-md-4 col-lg-3 t-icon"><i class="ti-align-justify"></i> ti-align-justify
                        </div>
                        <div class="col-sm-6 col-md-4 col-lg-3 t-icon"><i class="ti-align-center"></i> ti-align-center
                        </div>
                        <div class="col-sm-6 col-md-4 col-lg-3 t-icon"><i class="ti-quote-right"></i> ti-quote-right
                        </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="icon-list-demo row">
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 t-icon"><i class="ti-layout-width-default-alt"></i>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 t-icon"><i class="ti-layout-tab-v"></i> ti-layout-tab-v
                        </div>
                        <div class="col-sm-6 col-md-4 col-lg-3 t-icon"><i class="ti-layout-tab-min"></i>
                            ti-layout-tab-min
                        </div>
                        <div class="col-sm-6 col-md-4 col-lg-3 t-icon"><i class="ti-layout-slider"></i> ti-layout-slider
                        </div>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 t-icon"><i class="ti-layout-menu"></i> ti-layout-menu
                        </div>
                        <div class="col-sm-6 col-md-4 col-lg-3 t-icon"><i class="ti-layout-menu-v"></i> ti-layout-menu-v
                        </div>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 t-icon"><i class="ti-layout-media-right-alt"></i>
                            ti-layout-media-right-alt
                        </div>
                        <div class="col-sm-6 col-md-4 col-lg-3 t-icon"><i class="ti-layout-media-overlay"></i>
                            ti-layout-media-overlay
                        </div>
                        <div class="col-sm-6 col-md-4 col-lg-3 t-icon"><i class="ti-layout-media-overlay-alt"></i>
                            ti-layout-media-overlay-alt
                        </div>
                        <div class="col-sm-6 col-md-4 col-lg-3 t-icon"><i class="ti-layout-media-overlay-alt-2"></i>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 t-icon"><i class="ti-layout-media-center-alt"></i>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 t-icon"><i class="ti-layout-list-large-image"></i>
                            ti-layout-list-large-image
                        </div>
                        <div class="col-sm-6 col-md-4 col-lg-3 t-icon"><i class="ti-layout-line-solid"></i>
                            ti-layout-line-solid
                        </div>
                        <div class="col-sm-6 col-md-4 col-lg-3 t-icon"><i class="ti-layout-grid4"></i> ti-layout-grid4
                        </div>
                        <div class="col-sm-6 col-md-4 col-lg-3 t-icon"><i class="ti-layout-grid3"></i> ti-layout-grid3
                        </div>
                        <div class="col-sm-6 col-md-4 col-lg-3 t-icon"><i class="ti-layout-grid2"></i> ti-layout-grid2
                        </div>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 t-icon"><i class="ti-layout-accordion-separated"></i>
                            ti-layout-accordion-separated
                        </div>
                        <div class="col-sm-6 col-md-4 col-lg-3 t-icon"><i class="ti-layout-accordion-merged"></i>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 t-icon"><i class="ti-view-list-alt"></i> ti-view-list-alt
                        </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="icon-list-demo row">
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 t-icon"><i class="ti-dropbox-alt"></i> ti-dropbox-alt
                        </div>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 t-icon"><i class="ti-sharethis-alt"></i> ti-sharethis-alt
                        </div>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 t-icon"><i class="ti-microsoft-alt"></i> ti-microsoft-alt
                        </div>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 t-icon"><i class="ti-twitter-alt"></i> ti-twitter-alt
                        </div>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 t-icon"><i class="ti-pinterest-alt"></i> ti-pinterest-alt
                        </div>
                        <div class="col-sm-6 col-md-4 col-lg-3 t-icon"><i class="ti-themify-logo"></i> ti-themify-logo
                        </div>
