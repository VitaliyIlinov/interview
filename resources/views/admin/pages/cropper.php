<link rel="stylesheet" type="text/css" href="/libs/cropper/dist/cropper.min.css">
...
<div class="container-fluid dashboard-content">
                    ...
                    <div class="row">
                        <div class="col-md-9">
                            ...
                            <div class="img-container">
                                <img id="image" src="/admin/img/cropper/card-img-1.jpg" alt="Picture">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <!-- <h3>Preview:</h3> -->
    ...
    <div class="row">
        <div class="col-md-9 docs-buttons">
            <!-- <h3>Toolbar:</h3> -->
            <div class="btn-group">
                <button type="button" class="btn btn-outline-light" data-method="setDragMode" data-option="move"
                        title="Move">
                ...
                <button type="button" class="btn btn-outline-light" data-method="setDragMode" data-option="crop"
                        title="Crop">
                                <span class="docs-tooltip" data-toggle="tooltip" data-animation="false"
        ...
        <div class="col-md-3 docs-toggles">
            ...
            <div class="dropdown dropup docs-options">
                <button type="button" class="btn btn-outline-light btn-block dropdown-toggle" id="toggleOptions"
...
<script src="/libs/cropper/dist/cropper.min.js"></script>
<script src="/libs/cropper/dist/cropper-int.js"></script>
