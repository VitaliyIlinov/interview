...
<footer id="footer">
    ...
    <div class="container">
        <div class="copyright">
            &copy; Copyright <strong>VitaliyIlinov</strong>. All Rights Reserved
        </div>
        <div class="credits"> Designed by
            <a href="https://bootstrapmade.com/">VitaliyIlinov</a>
        </div>
    </div>
</footer>
...
<script src="js/mainregna.js"></script>
